...
Write a query that returns the person who has spent the most money.*/
 ...
 SELECT customer.customer_id, customer.first_name ||' '|| customer.last_name AS Name, sum(invoice.total) AS Total
 FROM customer
...
SELECT 
    ar.name AS artist_name, COUNT(t.track_id) AS total_tracks
FROM artist ar
...
WITH genre_sales AS (
    SELECT c.country, g.name AS genre, COUNT(il.quantity) AS total_purchases,
